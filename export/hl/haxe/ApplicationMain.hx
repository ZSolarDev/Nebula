...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Nebula", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Nebula", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Nebula";
		app.meta["name"] = "Nebula";
